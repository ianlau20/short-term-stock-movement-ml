...
- Team Members: Ian Lau, Jiho Hahn
...
improvements over multiple tickers. All models achieved performance close to chance level, highlighting
the difficulty of short-horizon financial prediction and motivating careful evaluation and ablation 
rather than raw accuracy optimization. These findings illustrate both the difficulty of short-term 
financial forecasting and the importance of model flexibility, feature design, and ticker-specific 
dynamics in uncovering weak predictive signals.
